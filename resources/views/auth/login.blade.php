...
<head>
    ...
    {{-- SEO --}}
    <meta name="description" content="بوابة تسجيل دخول المشرفين لمنظومة الثقافة — مديرية الثقافة بدمشق. أدخل رقم الهاتف وكلمة المرور للوصول إلى لوحة التحكم.">
    <link rel="canonical" href="{{ url()->current() }}">
    <meta name="theme-color" content="#0F4C3A">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="منظومة الثقافة">
    <meta property="og:title" content="تسجيل الدخول — منظومة الثقافة">
    <meta property="og:description" content="بوابة تسجيل دخول المشرفين لمنظومة الثقافة بدمشق.">
...
<body class="min-h-[100dvh] flex items-center justify-center p-4 relative overflow-x-hidden antialiased select-none">
    ...
    <main class="w-full max-w-[400px] rounded-[28px] sm:rounded-[32px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)] p-6 sm:p-9 pt-20 sm:pt-24 relative z-10 text-center border border-white/40 backdrop-blur-sm my-auto" style="background-color: #ffffff !important;">
      ...
      <div class="absolute -top-14 sm:-top-20 left-1/2 -translate-x-1/2 flex flex-col items-center justify-center z-20 w-full px-4">
        ...
        <form id="login-form" class="space-y-3.5">
            ...
            <div class="relative flex items-center">
                <input type="text" id="phone" name="phone" placeholder="09xxxxxxxx" aria-label="رقم الهاتف"
            ...
            <div class="relative flex items-center">
                <input type="password" id="password" name="password" placeholder="••••••••" aria-label="كلمة المرور"
                    style="background-color: #f8fafc !important;"
                ...
                <button type="button" id="toggle-password" aria-label="إظهار أو إخفاء كلمة المرور" class="absolute left-3.5 text-slate-400 hover:text-slate-600 focus:outline-none transition-colors p-1">
                    <svg class="w-4 h-4" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-6 sm:mt-8 text-[11px] font-bold text-slate-500">
